...
class multi_remove_request:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'hash_key', (pypegasus.base.ttypes.blob, pypegasus.base.ttypes.blob.thrift_spec), None, ), # 1
    (2, TType.LIST, 'sort_keys', (TType.STRUCT,(pypegasus.base.ttypes.blob, pypegasus.base.ttypes.blob.thrift_spec)), None, ), # 2
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.hash_key)
    value = (value * 31) ^ hash(self.sort_keys)
...
class batch_get_request:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'keys', (TType.STRUCT,(full_key, full_key.thrift_spec)), None, ), # 1
  )
...
class batch_get_response:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I32, 'error', None, None, ), # 1
    (2, TType.LIST, 'data', (TType.STRUCT,(full_data, full_data.thrift_spec)), None, ), # 2
    (3, TType.I32, 'app_id', None, None, ), # 3
    (4, TType.I32, 'partition_index', None, None, ), # 4
    None, # 5
    (6, TType.STRING, 'server', None, None, ), # 6
...
class get_scanner_request:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.sort_key_filter_type)
    value = (value * 31) ^ hash(self.sort_key_filter_pattern)
    value = (value * 31) ^ hash(self.validate_partition_hash)
    value = (value * 31) ^ hash(self.return_expire_ts)
    value = (value * 31) ^ hash(self.full_scan)
    value = (value * 31) ^ hash(self.only_return_count)
    return value
...
class scan_response:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.partition_index)
    value = (value * 31) ^ hash(self.server)
    value = (value * 31) ^ hash(self.kv_count)
    return value
