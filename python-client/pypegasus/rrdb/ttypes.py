...
class multi_remove_request(object):
    ...
    def __init__(self, hash_key=None, sort_keys=None, max_count=None,):
        self.hash_key = hash_key
    ...
    def write(self, oprot):
        ...
        if self.sort_keys is not None:
            oprot.writeFieldBegin('sort_keys', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.sort_keys))
            for iter13 in self.sort_keys:
                iter13.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class multi_get_request(object):
    ...
    def __init__(self, hash_key=None, sort_keys=None, max_kv_count=None, max_kv_size=None, no_value=None, start_sortkey=None, stop_sortkey=None, start_inclusive=None, stop_inclusive=None, sort_key_filter_type=None, sort_key_filter_pattern=None, reverse=None,):
        self.hash_key = hash_key
        self.sort_keys = sort_keys
...
class batch_get_request(object):
    """
    Attributes:
     - keys
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('batch_get_request')
...
class batch_get_response(object):
    """
    Attributes:
     - error
     - data
    ...
    def __init__(self, error=None, data=None, app_id=None, partition_index=None, server=None,):
        self.error = error
        self.data = data
        self.app_id = app_id
        self.partition_index = partition_index
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('batch_get_response')
        if self.error is not None:
            oprot.writeFieldBegin('error', TType.I32, 1)
            oprot.writeI32(self.error)
            oprot.writeFieldEnd()
...
class check_and_mutate_request(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i46 in range(_size42):
                        _elem47 = mutate()
                        _elem47.read(iprot)
                        self.mutate_list.append(_elem47)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if self.mutate_list is not None:
            ...
            for iter48 in self.mutate_list:
                iter48.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.return_check_value is not None:
...
class get_scanner_request(object):
    ...
    def __init__(self, start_key=None, stop_key=None, start_inclusive=None, stop_inclusive=None, batch_size=None, no_value=None, hash_key_filter_type=None, hash_key_filter_pattern=None, sort_key_filter_type=None, sort_key_filter_pattern=None, validate_partition_hash=None, return_expire_ts=None, full_scan=None, only_return_count=False,):
        ...
        self.sort_key_filter_type = sort_key_filter_type
        self.sort_key_filter_pattern = sort_key_filter_pattern
        self.validate_partition_hash = validate_partition_hash
        self.return_expire_ts = return_expire_ts
        self.full_scan = full_scan
        self.only_return_count = only_return_count
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.validate_partition_hash = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                if ftype == TType.BOOL:
                    self.return_expire_ts = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 13:
                if ftype == TType.BOOL:
                    self.full_scan = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 14:
                if ftype == TType.BOOL:
                    self.only_return_count = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.sort_key_filter_pattern is not None:
            ...
            self.sort_key_filter_pattern.write(oprot)
            oprot.writeFieldEnd()
        if self.validate_partition_hash is not None:
            oprot.writeFieldBegin('validate_partition_hash', TType.BOOL, 11)
            oprot.writeBool(self.validate_partition_hash)
            oprot.writeFieldEnd()
        if self.return_expire_ts is not None:
            oprot.writeFieldBegin('return_expire_ts', TType.BOOL, 12)
            oprot.writeBool(self.return_expire_ts)
            oprot.writeFieldEnd()
        if self.full_scan is not None:
            oprot.writeFieldBegin('full_scan', TType.BOOL, 13)
            oprot.writeBool(self.full_scan)
            oprot.writeFieldEnd()
        if self.only_return_count is not None:
            oprot.writeFieldBegin('only_return_count', TType.BOOL, 14)
            oprot.writeBool(self.only_return_count)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class scan_response(object):
    ...
    def __init__(self, error=None, kvs=None, context_id=None, app_id=None, partition_index=None, server=None, kv_count=None,):
        self.error = error
        self.kvs = kvs
        self.context_id = context_id
        self.app_id = app_id
    ...
    def write(self, oprot):
        ...
        if self.kv_count is not None:
            oprot.writeFieldBegin('kv_count', TType.I32, 7)
            oprot.writeI32(self.kv_count)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
multi_remove_request.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'hash_key', [pypegasus.base.ttypes.blob, None], None, ),  # 1
    (2, TType.LIST, 'sort_keys', (TType.STRUCT, [pypegasus.base.ttypes.blob, None], False), None, ),  # 2
...
all_structs.append(full_key)
full_key.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'hash_key', [pypegasus.base.ttypes.blob, None], None, ),  # 1
    (2, TType.STRUCT, 'sort_key', [pypegasus.base.ttypes.blob, None], None, ),  # 2
)
all_structs.append(batch_get_request)
batch_get_request.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'keys', (TType.STRUCT, [full_key, None], False), None, ),  # 1
)
all_structs.append(full_data)
full_data.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'hash_key', [pypegasus.base.ttypes.blob, None], None, ),  # 1
    (2, TType.STRUCT, 'sort_key', [pypegasus.base.ttypes.blob, None], None, ),  # 2
    (3, TType.STRUCT, 'value', [pypegasus.base.ttypes.blob, None], None, ),  # 3
)
all_structs.append(batch_get_response)
batch_get_response.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'error', None, None, ),  # 1
    (2, TType.LIST, 'data', (TType.STRUCT, [full_data, None], False), None, ),  # 2
    (3, TType.I32, 'app_id', None, None, ),  # 3
    (4, TType.I32, 'partition_index', None, None, ),  # 4
    None,  # 5
    (6, TType.STRING, 'server', 'UTF8', None, ),  # 6
...
get_scanner_request.thrift_spec = (
    ...
    (11, TType.BOOL, 'validate_partition_hash', None, None, ),  # 11
    (12, TType.BOOL, 'return_expire_ts', None, None, ),  # 12
    (13, TType.BOOL, 'full_scan', None, None, ),  # 13
    (14, TType.BOOL, 'only_return_count', None, False, ),  # 14
)
...
scan_response.thrift_spec = (
    ...
    (6, TType.STRING, 'server', 'UTF8', None, ),  # 6
    (7, TType.I32, 'kv_count', None, None, ),  # 7
)
