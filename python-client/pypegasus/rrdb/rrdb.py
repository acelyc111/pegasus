...
class batch_get_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'request', (batch_get_request, batch_get_request.thrift_spec), None, ), # 1
  )
...
class batch_get_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (batch_get_response, batch_get_response.thrift_spec), None, ), # 0
  )
