...
class Client(Iface):
    ...
    def batch_get(self, request):
        ...
        Parameters:
         - request
        """
        self.send_batch_get(request)
        return self.recv_batch_get()

    def send_batch_get(self, request):
        self._oprot.writeMessageBegin('batch_get', TMessageType.CALL, self._seqid)
        args = batch_get_args()
        args.request = request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_batch_get(self):
        ...
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "batch_get failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["batch_get"] = Processor.process_batch_get
    ...
    def process_batch_get(self, seqid, iprot, oprot):
        args = batch_get_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = batch_get_result()
        try:
            result.success = self._handler.batch_get(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("batch_get", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class batch_get_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.request = batch_get_request()
                    self.request.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('batch_get_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(batch_get_args)
batch_get_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [batch_get_request, None], None, ),  # 1
)


class batch_get_result(object):
    """
    Attributes:
     - success
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = batch_get_response()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('batch_get_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(batch_get_result)
batch_get_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [batch_get_response, None], None, ),  # 0
)
