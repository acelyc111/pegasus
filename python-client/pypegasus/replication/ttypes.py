...
class app_info(object):
    ...
    def __init__(self, status=0, app_type=None, app_name=None, app_id=None, partition_count=None, envs=None, is_stateful=None, max_replica_count=None, expire_second=None, create_second=None, drop_second=None, duplicating=False, init_partition_count=-1, is_bulk_loading=False,):
        self.status = status
...
all_structs.append(request_meta)
request_meta.thrift_spec = (
    None,  # 0
...
all_structs.append(app_info)
app_info.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'status', None, 0, ),  # 1
    (2, TType.STRING, 'app_type', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'app_name', 'UTF8', None, ),  # 3
    (4, TType.I32, 'app_id', None, None, ),  # 4
    (5, TType.I32, 'partition_count', None, None, ),  # 5
    (6, TType.MAP, 'envs', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None, ),  # 6
