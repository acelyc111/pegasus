...
const std::set<std::string> VALID_USAGE_SCENARIOS({ROCKSDB_ENV_USAGE_SCENARIO_NORMAL, ROCKSDB_ENV_USAGE_SCENARIO_PREFER_WRITE, ROCKSDB_ENV_USAGE_SCENARIO_BULK_LOAD});
