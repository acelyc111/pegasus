...
#define CHECK_EQ(var1, var2) CHECK_F(var1 == var2, "{} vs {}", var1, var2)
#define CHECK_GE(var1, var2) CHECK_F(var1 >= var2, "{} vs {}", var1, var2)
#define CHECK_LE(var1, var2) CHECK_F(var1 <= var2, "{} vs {}", var1, var2)
#define CHECK_GT(var1, var2) CHECK_F(var1 > var2, "{} vs {}", var1, var2)
#define CHECK_LT(var1, var2) CHECK_F(var1 < var2, "{} vs {}", var1, var2)

#define CHECK_EQ_PREFIX(var1, var2) CHECK_PREFIX(var1 == var2, "{} vs {}", var1, var2)
#define CHECK_GE_PREFIX(var1, var2) CHECK_PREFIX(var1 >= var2, "{} vs {}", var1, var2)
#define CHECK_LE_PREFIX(var1, var2) CHECK_PREFIX(var1 <= var2, "{} vs {}", var1, var2)
#define CHECK_GT_PREFIX(var1, var2) CHECK_PREFIX(var1 > var2, "{} vs {}", var1, var2)
#define CHECK_LT_PREFIX(var1, var2) CHECK_PREFIX(var1 < var2, "{} vs {}", var1, var2)
