...
#define CHECK_PREFIX(x, ...) CHECK_F(x, "[{}] {}", log_prefix(), fmt::format(__VA_ARGS__))

// Macros to check expected condition. It will abort the application
// and log a fatal message when the condition is not met.
#define dcheck_eq(var1, var2) CHECK_F(var1 == var2, "{} vs {}", var1, var2)
#define dcheck_ge(var1, var2) CHECK_F(var1 >= var2, "{} vs {}", var1, var2)
#define dcheck_le(var1, var2) CHECK_F(var1 <= var2, "{} vs {}", var1, var2)
#define dcheck_gt(var1, var2) CHECK_F(var1 > var2, "{} vs {}", var1, var2)
#define dcheck_lt(var1, var2) CHECK_F(var1 < var2, "{} vs {}", var1, var2)

#define dcheck_eq_replica(var1, var2) CHECK_PREFIX(var1 == var2, "{} vs {}", var1, var2)
#define dcheck_ge_replica(var1, var2) CHECK_PREFIX(var1 >= var2, "{} vs {}", var1, var2)
#define dcheck_le_replica(var1, var2) CHECK_PREFIX(var1 <= var2, "{} vs {}", var1, var2)
#define dcheck_gt_replica(var1, var2) CHECK_PREFIX(var1 > var2, "{} vs {}", var1, var2)
#define dcheck_lt_replica(var1, var2) CHECK_PREFIX(var1 < var2, "{} vs {}", var1, var2)
