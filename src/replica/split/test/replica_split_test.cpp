...
public:
    ...
    void mock_parent_primary_configuration(bool lack_of_secondary = false)
    {
        ...
        ADD_IP_AND_HOST_PORT_BY_DNS(pc, secondaries1, SECONDARY);
        if (!lack_of_secondary) {
            ADD_IP_AND_HOST_PORT_BY_DNS(pc, secondaries1, SECONDARY2);
        }
    ...
    void test_on_register_child_reply(partition_status::type status, dsn::error_code resp_err)
    {
        ...
        SET_IP_AND_HOST_PORT_BY_DNS(req.parent_config, primary1, PRIMARY);
