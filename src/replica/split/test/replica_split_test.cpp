...
public:
                                                   ...
                                                   ballot b)
    {
        ...
        req.ballot = b;
        req.host_port_target_address = PRIMARY;
    ...
    error_code test_parent_handle_child_catch_up(ballot child_ballot)
    {
        ...
        req.host_port_child_address = PRIMARY;
