...
public:
    ...
    void mock_parent_primary_configuration(bool lack_of_secondary = false)
    {
        ...
        config.host_port_secondaries.emplace_back(SECONDARY);
                                                   ...
                                                   ballot b)
    {
        ...
        req.ballot = b;
        req.__set_host_port_target_address(PRIMARY);
    ...
    error_code test_parent_handle_child_catch_up(ballot child_ballot)
    {
        ...
        req.__set_host_port_child_address(PRIMARY);
                                                             ...
                                                             split_status::type local_split_status)
    {
        ...
        req.__set_host_port_node(SECONDARY);
...
public:
    ...
    const host_port PRIMARY = host_port("127.0.0.1", 18230);
    const host_port SECONDARY = host_port("127.0.0.2", 10058);
    const host_port SECONDARY2 = host_port("127.0.0.3", 10805);
