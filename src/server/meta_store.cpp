...
uint64_t meta_store::get_last_flushed_decree(meta_store_type type) const
{
    ...
    case meta_store_type::kMetaCFOnly: {
        ...
        auto ec =
            get_value_from_meta_cf(true, LAST_FLUSHED_DECREE, &last_flushed_decree);
...
uint64_t meta_store::get_last_manual_compact_finish_time(meta_store_type type) const
{
    ...
    case meta_store_type::kMetaCFOnly: {
        ...
        auto ec = get_value_from_meta_cf(false,
...
::dsn::error_code
meta_store::set_value_to_meta_cf(const std::string &key, uint64_t value) const
{
