...
private:
    ::dsn::error_code
    get_int_value_from_meta_cf(bool read_flushed_data, const std::string &key, uint64_t *value) const;
    ::dsn::error_code set_int_value_to_meta_cf(const std::string &key, uint64_t value) const;
    static ::dsn::error_code get_int_value_from_meta_cf(rocksdb::DB *db,
    ...
    ::dsn::error_code
    get_string_value_from_meta_cf(bool read_flushed_data, const std::string &key, const std::string *value) const;
    static ::dsn::error_code
    get_string_value_from_meta_cf(rocksdb::DB *db,
                                  rocksdb::ColumnFamilyHandle *cf,
                                  bool read_flushed_data,
                                  const std::string &key,
                                  std::string *value) const;
    ::dsn::error_code set_string_value_to_meta_cf(const std::string &key, const std::string& value) const;

    friend class pegasus_write_service;

    // Keys of meta data wrote into meta column family.
    static const std::string DATA_VERSION;
    static const std::string USAGE_SCENARIO;
