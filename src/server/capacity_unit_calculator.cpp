...
{
    CHECK(_read_hotkey_collector != nullptr, "read hotkey collector is a nullptr");
    CHECK(_write_hotkey_collector != nullptr, "write hotkey collector is a nullptr");
    CHECK(_read_size_throttling_controller != nullptr,
