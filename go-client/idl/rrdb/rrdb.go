...
func (p *DuplicateRequest) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *DuplicateRequest)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  _, size, err := iprot.ReadListBegin(ctx)
  if err != nil {
    return thrift.PrependError("error reading list begin: ", err)
  }
  ...
  p.Entries =  tSlice
  for i := 0; i < size; i ++ {
    _elem16 := &DuplicateEntry{}
    if err := _elem16.Read(ctx, iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem16), err)
    }
    p.Entries = append(p.Entries, _elem16)
  }
  if err := iprot.ReadListEnd(ctx); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *DuplicateRequest) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "duplicate_request"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
  }
...
func (p *DuplicateRequest) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
...
func (p *DuplicateRequest) Equals(other *DuplicateRequest) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
...
func (p *DuplicateEntry) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *DuplicateEntry)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.Timestamp = &v
...
func (p *DuplicateEntry)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  p.TaskCode = &base.TaskCode{}
  if err := p.TaskCode.Read(ctx, iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.TaskCode), err)
  }
  return nil
}

func (p *DuplicateEntry)  ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
  p.RawMessage = &base.Blob{}
  if err := p.RawMessage.Read(ctx, iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.RawMessage), err)
  }
  return nil
}

func (p *DuplicateEntry)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *DuplicateEntry)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(ctx); err != nil {
  return thrift.PrependError("error reading field 5: ", err)
} else {
  p.VerifyTimetag = &v
...
func (p *DuplicateEntry) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "duplicate_entry"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
    if err := p.writeField2(ctx, oprot); err != nil { return err }
...
func (p *DuplicateEntry) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetTimestamp() {
...
func (p *DuplicateEntry) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetTaskCode() {
    if err := oprot.WriteFieldBegin(ctx, "task_code", thrift.STRUCT, 2); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:task_code: ", p), err) }
    if err := p.TaskCode.Write(ctx, oprot); err != nil {
...
func (p *DuplicateEntry) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetRawMessage() {
    if err := oprot.WriteFieldBegin(ctx, "raw_message", thrift.STRUCT, 3); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:raw_message: ", p), err) }
    if err := p.RawMessage.Write(ctx, oprot); err != nil {
...
func (p *DuplicateEntry) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetClusterID() {
    if err := oprot.WriteFieldBegin(ctx, "cluster_id", thrift.BYTE, 4); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:cluster_id: ", p), err) }
    if err := oprot.WriteByte(ctx, int8(*p.ClusterID)); err != nil {
...
func (p *DuplicateEntry) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetVerifyTimetag() {
    if err := oprot.WriteFieldBegin(ctx, "verify_timetag", thrift.BOOL, 5); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:verify_timetag: ", p), err) }
    if err := oprot.WriteBool(ctx, bool(*p.VerifyTimetag)); err != nil {
...
func (p *DuplicateEntry) Equals(other *DuplicateEntry) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if !p.TaskCode.Equals(other.TaskCode) { return false }
  if !p.RawMessage.Equals(other.RawMessage) { return false }
  ...
  if p.VerifyTimetag != other.VerifyTimetag {
    if p.VerifyTimetag == nil || other.VerifyTimetag == nil {
      return false
    }
    if (*p.VerifyTimetag) != (*other.VerifyTimetag) { return false }
  }
  return true
}
...
func (p *DuplicateResponse) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *DuplicateResponse)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.Error = &v
...
func (p *DuplicateResponse)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.ErrorHint = &v
...
func (p *DuplicateResponse) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "duplicate_response"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
    if err := p.writeField2(ctx, oprot); err != nil { return err }
...
func (p *DuplicateResponse) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetError() {
    if err := oprot.WriteFieldBegin(ctx, "error", thrift.I32, 1); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:error: ", p), err) }
    if err := oprot.WriteI32(ctx, int32(*p.Error)); err != nil {
...
func (p *DuplicateResponse) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetErrorHint() {
    if err := oprot.WriteFieldBegin(ctx, "error_hint", thrift.STRING, 2); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:error_hint: ", p), err) }
    if err := oprot.WriteString(ctx, string(*p.ErrorHint)); err != nil {
...
func (p *DuplicateResponse) Equals(other *DuplicateResponse) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
  ...
  if p.Error != other.Error {
    if p.Error == nil || other.Error == nil {
      return false
    }
    if (*p.Error) != (*other.Error) { return false }
  }
  if p.ErrorHint != other.ErrorHint {
    if p.ErrorHint == nil || other.ErrorHint == nil {
      return false
    }
    if (*p.ErrorHint) != (*other.ErrorHint) { return false }
  }
  return true
}
...
func (p *RrdbClient) Put(ctx context.Context, update *UpdateRequest) (_r *UpdateResponse, _err error) {
  var _args18 RrdbPutArgs
  _args18.Update = update
  var _result20 RrdbPutResult
  var _meta19 thrift.ResponseMeta
  _meta19, _err = p.Client_().Call(ctx, "put", &_args18, &_result20)
...
func (p *RrdbClient) MultiPut(ctx context.Context, request *MultiPutRequest) (_r *UpdateResponse, _err error) {
  var _args21 RrdbMultiPutArgs
  _args21.Request = request
  var _result23 RrdbMultiPutResult
  var _meta22 thrift.ResponseMeta
  _meta22, _err = p.Client_().Call(ctx, "multi_put", &_args21, &_result23)
...
func (p *RrdbClient) MultiRemove(ctx context.Context, request *MultiRemoveRequest) (_r *MultiRemoveResponse, _err error) {
  var _args27 RrdbMultiRemoveArgs
  _args27.Request = request
  var _result29 RrdbMultiRemoveResult
  var _meta28 thrift.ResponseMeta
  _meta28, _err = p.Client_().Call(ctx, "multi_remove", &_args27, &_result29)
...
func (p *RrdbClient) Incr(ctx context.Context, request *IncrRequest) (_r *IncrResponse, _err error) {
  var _args30 RrdbIncrArgs
  _args30.Request = request
  var _result32 RrdbIncrResult
  var _meta31 thrift.ResponseMeta
  _meta31, _err = p.Client_().Call(ctx, "incr", &_args30, &_result32)
...
func (p *RrdbClient) CheckAndSet(ctx context.Context, request *CheckAndSetRequest) (_r *CheckAndSetResponse, _err error) {
  var _args33 RrdbCheckAndSetArgs
  _args33.Request = request
  var _result35 RrdbCheckAndSetResult
  var _meta34 thrift.ResponseMeta
  _meta34, _err = p.Client_().Call(ctx, "check_and_set", &_args33, &_result35)
...
func (p *RrdbClient) CheckAndMutate(ctx context.Context, request *CheckAndMutateRequest) (_r *CheckAndMutateResponse, _err error) {
  var _args36 RrdbCheckAndMutateArgs
  _args36.Request = request
  var _result38 RrdbCheckAndMutateResult
  var _meta37 thrift.ResponseMeta
  _meta37, _err = p.Client_().Call(ctx, "check_and_mutate", &_args36, &_result38)
...
func (p *RrdbClient) Get(ctx context.Context, key *base.Blob) (_r *ReadResponse, _err error) {
  var _args39 RrdbGetArgs
  _args39.Key = key
  var _result41 RrdbGetResult
  var _meta40 thrift.ResponseMeta
  _meta40, _err = p.Client_().Call(ctx, "get", &_args39, &_result41)
...
func (p *RrdbClient) MultiGet(ctx context.Context, request *MultiGetRequest) (_r *MultiGetResponse, _err error) {
  var _args42 RrdbMultiGetArgs
  _args42.Request = request
  var _result44 RrdbMultiGetResult
  var _meta43 thrift.ResponseMeta
  _meta43, _err = p.Client_().Call(ctx, "multi_get", &_args42, &_result44)
...
func (p *RrdbClient) BatchGet(ctx context.Context, request *BatchGetRequest) (_r *BatchGetResponse, _err error) {
  var _args45 RrdbBatchGetArgs
  _args45.Request = request
  var _result47 RrdbBatchGetResult
  var _meta46 thrift.ResponseMeta
  _meta46, _err = p.Client_().Call(ctx, "batch_get", &_args45, &_result47)
...
func (p *RrdbClient) SortkeyCount(ctx context.Context, hash_key *base.Blob) (_r *CountResponse, _err error) {
  var _args48 RrdbSortkeyCountArgs
  _args48.HashKey = hash_key
  var _result50 RrdbSortkeyCountResult
  var _meta49 thrift.ResponseMeta
  _meta49, _err = p.Client_().Call(ctx, "sortkey_count", &_args48, &_result50)
...
func (p *RrdbClient) TTL(ctx context.Context, key *base.Blob) (_r *TTLResponse, _err error) {
  var _args51 RrdbTTLArgs
  _args51.Key = key
  var _result53 RrdbTTLResult
  var _meta52 thrift.ResponseMeta
  _meta52, _err = p.Client_().Call(ctx, "ttl", &_args51, &_result53)
...
func (p *RrdbClient) GetScanner(ctx context.Context, request *GetScannerRequest) (_r *ScanResponse, _err error) {
  var _args54 RrdbGetScannerArgs
  _args54.Request = request
  var _result56 RrdbGetScannerResult
  var _meta55 thrift.ResponseMeta
  _meta55, _err = p.Client_().Call(ctx, "get_scanner", &_args54, &_result56)
...
func (p *RrdbClient) Scan(ctx context.Context, request *ScanRequest) (_r *ScanResponse, _err error) {
  var _args57 RrdbScanArgs
  _args57.Request = request
  var _result59 RrdbScanResult
  var _meta58 thrift.ResponseMeta
  _meta58, _err = p.Client_().Call(ctx, "scan", &_args57, &_result59)
...
func (p *RrdbClient) ClearScanner(ctx context.Context, context_id int64) (_err error) {
  var _args60 RrdbClearScannerArgs
  _args60.ContextID = context_id
  p.SetLastResponseMeta_(thrift.ResponseMeta{})
  if _, err := p.Client_().Call(ctx, "clear_scanner", &_args60, nil); err != nil {
    return err
  }
  return nil
}
...
func NewRrdbProcessor(handler Rrdb) *RrdbProcessor {
  ...
  self61 := &RrdbProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self61.processorMap["put"] = &rrdbProcessorPut{handler:handler}
  self61.processorMap["multi_put"] = &rrdbProcessorMultiPut{handler:handler}
  self61.processorMap["remove"] = &rrdbProcessorRemove{handler:handler}
  self61.processorMap["multi_remove"] = &rrdbProcessorMultiRemove{handler:handler}
  self61.processorMap["incr"] = &rrdbProcessorIncr{handler:handler}
  self61.processorMap["check_and_set"] = &rrdbProcessorCheckAndSet{handler:handler}
  self61.processorMap["check_and_mutate"] = &rrdbProcessorCheckAndMutate{handler:handler}
  self61.processorMap["get"] = &rrdbProcessorGet{handler:handler}
  self61.processorMap["multi_get"] = &rrdbProcessorMultiGet{handler:handler}
  self61.processorMap["batch_get"] = &rrdbProcessorBatchGet{handler:handler}
  self61.processorMap["sortkey_count"] = &rrdbProcessorSortkeyCount{handler:handler}
  self61.processorMap["ttl"] = &rrdbProcessorTTL{handler:handler}
  self61.processorMap["get_scanner"] = &rrdbProcessorGetScanner{handler:handler}
  self61.processorMap["scan"] = &rrdbProcessorScan{handler:handler}
  self61.processorMap["clear_scanner"] = &rrdbProcessorClearScanner{handler:handler}
return self61
}
