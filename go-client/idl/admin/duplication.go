...
type DuplicationAddRequest struct {
  ...
  IsDuplicatingCheckpoint bool `thrift:"is_duplicating_checkpoint,3" db:"is_duplicating_checkpoint" json:"is_duplicating_checkpoint,omitempty"`
}
...
type DuplicationConfirmEntry struct {
  ...
  CheckpointPrepared bool `thrift:"checkpoint_prepared,3" db:"checkpoint_prepared" json:"checkpoint_prepared,omitempty"`
}
